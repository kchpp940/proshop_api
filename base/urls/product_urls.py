...
urlpatterns = [
    ...
    path('import/', views.importProducts, name='product-import'),
    path('import/tasks/', views.getImportTasks, name='import-tasks'),
    path('import/tasks/<str:pk>/', views.getImportTask,
